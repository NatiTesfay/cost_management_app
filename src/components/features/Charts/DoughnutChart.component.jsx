...
const Categories = {
    ...
    Logo: LogoCategoryArr.length,
    Partywear: PartywearCategoryArr.length,
    Backpacks: BackpacksCategoryArr.length,
    Clutches: ClutchesCategoryArr.length,
    Shoulder: ShoulderCategoryArr.length
}
    const data = {
      labels: ["CROSSBODY BAGS", "LOGO BAGS", "PARTYWEAR", "BACKPACKS", "CLUTCHES", "SHOULDER" ],
      datasets: [
        {
          label: 'Departments pie',
          data: [CrossbodyCategoryArr.length, LogoCategoryArr.length, PartywearCategoryArr.length, BackpacksCategoryArr.length, ClutchesCategoryArr.length, ShoulderCategoryArr.length],
          backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(54, 162, 235, 0.2)',
            'rgba(255, 206, 86, 0.2)',
